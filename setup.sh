sudo apt-get install make cmake autoconf libxslt1.1 xsltproc libopenvas9 automake libmicrohttpd-dev libxml2-dev libxslt1-dev pkg-config flex cmake libssh-dev sqlite3 libsqlite3-dev libgnutls30  libglib2.0-dev libpcap-dev libgpgme-dev uuid-dev bison libksba-dev nmap rpm libgcrypt20-dev
