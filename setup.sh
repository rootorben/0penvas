sudo apt-get install make cmake autoconf gnutls libxslt1.1 xsltproc libopenvas9 automake libmicrohttpd-dev libxml2-dev libxslt1-dev pkg-config flex cmake libssh-dev sqlite3 libsqlite3-dev libgnutls30 libgnutls28-dev libgcrypt11-dev libglib2.0-dev libpcap-dev libgpgme11-dev uuid-dev bison libksba-dev nmap rpm;
